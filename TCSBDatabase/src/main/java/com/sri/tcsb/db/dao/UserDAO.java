...
import com.sri.tcsb.db.dto.KeyValueMaster;
import com.sri.tcsb.db.dto.PORAFunctionalities;
import com.sri.tcsb.db.dto.User;
import com.sri.tcsb.db.dto.UserPermissions;
import com.sri.tcsb.db.exception.AddException;
import com.sri.tcsb.db.exception.DeleteException;
import com.sri.tcsb.db.exception.FetchDataException;
import com.sri.tcsb.db.exception.PrimaryKeyException;
import com.sri.tcsb.db.exception.RecordNotFoundException;
import com.sri.tcsb.db.exception.UpdateException;
import com.sri.tcsb.db.util.HibernateUtil;
import com.sri.tcsb.logger.TCSBLogger;


public class UserDAO {
	
	TCSBLogger log = TCSBLogger.getLogger(UserDAO.class.getName());
